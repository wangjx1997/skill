...
public class DynamicDataSourceRegister implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    private void initslaveDataSources(Environment env) {
        // 读取配置文件获取更多数据源
        String dsPrefixs = env.getProperty("datasource.names");
        for (String dsPrefix : dsPrefixs.split(",")) {
            // 多个数据源
            Map<String, Object> dsMap = new HashMap<>();
            dsMap.put("driver", env.getProperty("datasource." + dsPrefix + ".driver"));
            dsMap.put("url", env.getProperty("datasource." + dsPrefix + ".url"));
            dsMap.put("username", env.getProperty("datasource." + dsPrefix + ".username"));
            dsMap.put("password", env.getProperty("datasource." + dsPrefix + ".password"));
